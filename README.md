...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/orange3-textable-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15441&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/orange3-textable-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `orange3-textable` can be installed with:

```
conda install orange3-textable
```

It is possible to list all of the versions of `orange3-textable` available on your platform with:
